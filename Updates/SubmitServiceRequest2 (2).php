...
<body class="bg-info">
  ...
  <div class="container " >
    ...
    <br>
      <br>
      <form method ="post" action="SubmitServiceRequest2 (2).php">
    ...
    <div class="input-group mb-3">
      ...
      <div class="container mt-3">
        ...
        <div class="input-group mb-3">
                  ...
                  <input type="time" class="form-control"  id = "requiredTime" name = "requiredTime"></text>
                </div>
...
<a href="SelectViewRating.html" class="btn btn-danger btn-block" role="button">View Rating</a>
    ...
    //  echo " uname".$uname;
      ...
      $sql = "INSERT INTO servicerequest (requiredDate, requiredTime, notes, status, service, senior) VALUES ('$date', '$time', '$notes', 'pending', '$serviceCode', '$username')";
      ...
      $set=mysqli_query($db,$sql);
       if ($set === TRUE) {
           ...
           window.location.href = 'SubmitServiceRequest2 (2).php';
           </script>";
       } else {
