      ...
      <form action="connection.php"  method="post">
        ...
        <div class="container mt-3">
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Full Name" id="fullame" name="fullname" required>
          </div>
          ...
          <div class="input-group mb-3">
            ...
            <input type="tel" class="form-control" placeholder="Contact Details" id="mobileNo" name="mobileNo" required>
          </div>
          ...
          <br>
        <button type="submit" class="btn btn-danger"onclick="return validateSignupForm();"> Sign Up</button>
  <!--    <a href="SubmitServiceRequest.html"  type="submit" class="btn btn-danger"onclick="return validateSignupForm();"> Sign Up</a>-->
