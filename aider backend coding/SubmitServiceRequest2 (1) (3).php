...
<body class="bg-info">
  <script>
    function noEdit(){
      document.getElementById("serviceName").readOnly = true;
    }
  </script>
  ...
  <div class="container " >
    ...
    <br>
      <br>
      <form method ="post" action="SubmitServiceRequest2 (1).php">
    ...
    <div class="input-group mb-3">
      ...
      <input type="text" class="form-control" id = "serviceName" name = "serviceName" value="<?php echo $serviceName;?>" onfocus="noEdit();">
    </div>
    ...
    //  echo " uname".$uname;
      ...
      $set=mysqli_query($db,$sql);
       if ($set === TRUE) {
           ...
           window.location.href = 'SubmitServiceRequest2 (1).php';
           </script>";
       } else {
